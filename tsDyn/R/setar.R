...
ret<-list(res=res, res2=res2,bests=bests, th=getTh(bests), nthresh=nthresh, allTh=allres, criterion=criterion,firstBests=firstBests, bests2th=bests2th,criterion=criterion, ML=ML, MM=MM, MH=MH, same.lags=same.lags)
